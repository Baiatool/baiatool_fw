...
struct wifi_cmd_msg {
	...
	char ssid[CONFIG_WIFI_SSID_MAX_LEN + 1]; /**< SSID of the Wi-Fi network to connect (for WIFI_CMD_CONNECT) */
	char psk[CONFIG_WIFI_PSK_MAX_LEN + 1]; 	 /**< PSK (password) of the Wi-Fi network to connect (for WIFI_CMD_CONNECT) */
